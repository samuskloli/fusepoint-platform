  ...
  setup(props, { emit }) {
    ...
    const loadConversations = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/accompagnement/conversations?${params}`)
        if (response.ok) {
    ...
    const loadMessages = async (conversationId) => {
      try {
        const response = await fetch(`/api/accompagnement/conversations/${conversationId}/messages`)
        if (response.ok) {
    ...
    const sendMessage = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/accompagnement/conversations/${selectedConversation.value.id}/messages`, {
          method: 'POST',
          body: formData
        })
    ...
    const markAsRead = async (conversationId) => {
      try {
        await fetch(`/api/accompagnement/conversations/${conversationId}/read`, {
          method: 'POST'
        })
