          ...
          <div class="grid grid-cols-12 gap-4 items-center">
            ...
            <div class="hidden lg:contents">
              ...
              <div class="col-span-1 text-center">
                <StatusBadge :client="client" :messages="messages" />
              </div>
...
export default {
  ...
  emits: ['toggleAll', 'selectClient', 'editClient', 'deleteClient', 'retry', 'assignAgent', 'sendEmail', 'sendNotification', 'sendMessage', 'toggleStatus'],
  methods: {
