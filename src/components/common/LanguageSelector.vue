  ...
  <div class="language-selector">
    ...
    <div v-if="variant === 'dropdown'" class="relative">
      ...
      >
        ...
        <span v-if="showLabel">{{ currentLanguageInfo.nativeName }}</span>
      ...
      >
        <div class="py-1">
          ...
          >
            ...
            <svg v-if="language.code === currentLanguage" class="w-4 h-4 ml-auto text-blue-600" fill="currentColor" viewBox="0 0 20 20">
    ...
    <!-- Version boutons inline -->
    <div v-else-if="variant === 'buttons'" class="flex items-center space-x-1">
      <button
        v-for="language in availableLanguages"
        :key="language.code"
        @click="selectLanguage(language.code)"
        class="flex items-center px-2 py-1 text-sm font-medium rounded transition-colors"
        :class="[
      ...
      >
        ...
        <span v-if="showLabel" class="ml-1">{{ language.code.toUpperCase() }}</span>
      </button>
    </div>
