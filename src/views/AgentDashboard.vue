        ...
        <div class="container mx-auto px-6 py-8">
          ...
          <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">
              Bonjour {{ authStore.user?.first_name }} {{ authStore.user?.last_name }}, voici un aperçu de votre activité aujourd'hui.
            </p>
          </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-gray-500">{{ getActiveChats() }} conversations actives</p>
                </div>
