...
export default {
  ...
  setup() {
    ...
    const tabs = [
      ...
      { id: 'projects', name: 'Projets', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
      { id: 'calendar', name: 'Agenda', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
      { id: 'tasks', name: 'Tâches', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
    ...
    const editProject = (project) => {
      console.log('ProjectManagement.vue - editProject called with:', project)
      console.log('ProjectManagement.vue - project keys:', Object.keys(project || {}))
      console.log('ProjectManagement.vue - project values:', project)
      selectedProject.value = project
      console.log('ProjectManagement.vue - selectedProject.value set to:', selectedProject.value)
      showEditProjectModal.value = true
      console.log('ProjectManagement.vue - showEditProjectModal set to true')
    }
